...
# Update DB-IP every Saturday at a random minute between 1 and 59 after 2 AM
...
/usr/local/openbmp/db-ip-import.sh 2>/var/log/openbmp/cron-dbip-import.log >> /var/log/openbmp/cron-dbip-import.log 2>&1

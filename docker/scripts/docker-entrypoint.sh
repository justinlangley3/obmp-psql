...
# Optional services
[[ "${ENABLE_RPKI}" == "1" ]] && /usr/local/openbmp/jobs/enable_rpki.sh &
[[ "${ENABLE_DBIP}" == "1" ]] && /usr/local/openbmp/jobs/enable_dbip.sh &
[[ "${ENABLE_IRR}"  == "1" ]] && /usr/local/openbmp/jobs/enable_irr.sh &
